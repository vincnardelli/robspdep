#' Permutation test for MMC statistic
#'
#'
#'  A permutation test for MMC statistic calculated by using nsim random
...
#'
#' @examples
#' mmc(sampledata$x,sampledata$w)

mmc <- function(x, listw, alternative="greater", nsim=999) {
